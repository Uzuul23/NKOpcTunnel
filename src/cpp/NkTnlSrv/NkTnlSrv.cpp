	...
	try {
		if ((argc > 1) && ((*argv[1] == L'-' || (*argv[1] == L'/')))) {
			if (_wcsicmp(L"h", argv[1] + 1) == 0) {
				...
				key.CreateKey(NKOPCTnl::RegKeySettings, &keySettings, KEY_WRITE);
				keySettings.SetValue(NKOPCTnl::DefaultTraceLevel, NKOPCTnl::RegValueServerTraceLevel);
				...
				key.CreateKey(NKOPCTnl::RegKeySettings, &keySettings, KEY_WRITE);
				keySettings.SetValue(NKOPCTnl::DefaultServerVerifyClient, NKOPCTnl::RegValueServerVerifyClient);
				...
				key.CreateKey(NKOPCTnl::RegKeySettings, &keySettings, KEY_WRITE);
				keySettings.SetValue(str.c_str(), NKOPCTnl::RegValueServerCertPath);
				...
				keySettings.DeleteKeyValueIf(NKOPCTnl::RegValueServerInstallPath);
				keySettings.DeleteKeyValueIf(NKOPCTnl::RegValueServerPort);
				keySettings.DeleteKeyValueIf(NKOPCTnl::RegValueServerTraceLevel);
				keySettings.DeleteKeyValueIf(NKOPCTnl::RegValueServerIPAddress);
				keySettings.DeleteKeyValueIf(NKOPCTnl::RegValueServerUseSSL);
				keySettings.DeleteKeyValueIf(NKOPCTnl::RegValueServerVerifyClient);
				keySettings.DeleteKeyValueIf(NKOPCTnl::RegValueServerCertPath);
